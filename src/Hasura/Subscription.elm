...
-}
follow_connection : (FollowConnectionOptionalArguments -> FollowConnectionOptionalArguments) -> SelectionSet decodesTo Hasura.Object.Follow_connection -> SelectionSet (List decodesTo) RootSubscription
...
-}
follow_connection_aggregate : (FollowConnectionAggregateOptionalArguments -> FollowConnectionAggregateOptionalArguments) -> SelectionSet decodesTo Hasura.Object.Follow_connection_aggregate -> SelectionSet decodesTo RootSubscription
...
-}
follow_connection_by_pk : FollowConnectionByPkRequiredArguments -> SelectionSet decodesTo Hasura.Object.Follow_connection -> SelectionSet (Maybe decodesTo) RootSubscription
...
-}
user : (UserOptionalArguments -> UserOptionalArguments) -> SelectionSet decodesTo Hasura.Object.User -> SelectionSet (List decodesTo) RootSubscription
...
-}
user_aggregate : (UserAggregateOptionalArguments -> UserAggregateOptionalArguments) -> SelectionSet decodesTo Hasura.Object.User_aggregate -> SelectionSet decodesTo RootSubscription
...
-}
user_by_pk : UserByPkRequiredArguments -> SelectionSet decodesTo Hasura.Object.User -> SelectionSet (Maybe decodesTo) RootSubscription
